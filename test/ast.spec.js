...
describe('AST', () => {
    ...
    describe('select statement', () => {
        ...
        describe('expression', () => {
            ...
            it.skip('should support pg double colon cast', () => {
                const castQueries = {
                    'colon cast': [
        ...
        describe('joins', () => {
            ...
            it.skip('should support RIGHT JOINs', () => {
            ...
            it.skip('should support FULL JOINs', () => {
    ...
    describe('expression parsing', () => {
        ...
        it.skip('should be able to get columns from ast', () => {
    ...
    describe('jsonb operator ast order', () => {
      it.skip('should parse jsonb operator ast order correct', () => {
