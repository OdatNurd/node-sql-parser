...
describe('Command SQL', () => {
  ...
  describe('alter', () => {
    ...
    it.skip(`should support MySQL alter drop check and column`, () => {
    ...
    ["fulltext", "spatial"].forEach(kc => {
      it.skip(`should support MySQL alter add ${kc} index or key`, () => {
        ["index", "key"].forEach(keyword => {
  ...
  describe('declare in tsql', () => {
    ...
    it.skip('should support declare table', () => {
    ...
    it.skip('should support declare with other sql', () => {
  ...
  describe('go', () => {
    ...
    it.skip(`should support multiple go`, () => {
